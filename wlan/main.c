...
/* Vendor board-file helper not in mainline; falls through to random MAC. */
static inline int get_custom_mac_address(int fmt, char *name, char *addr) { return -ENOENT; }
...
static const struct proc_ops hwinfo_proc_op = {
